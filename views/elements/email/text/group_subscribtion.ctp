...
<?php echo $user['User']['username']; ?> joined your group <?php echo $group['Group']['name']; ?>. 

To see more information about <?php echo $user['User']['username']; ?>, please visit <?php echo Router::url("/users/view/{$user['User']['username']}", true); ?>.
