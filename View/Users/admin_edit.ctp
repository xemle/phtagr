...
<?php echo $this->Form->create(null, array('action' => 'edit/'.$this->data['User']['id'])); ?>
...
<?php
  ...
  echo $this->Form->input('User.role', array('type' => 'select', 'options' => $roles, 'selected' => $this->data['User']['role']));
?>
</fieldset>
...
<?php
  ...
  echo $this->Form->input('User.quota', array('type' => 'text', 'label' => __('Upload Quota'), 'value' => $this->Number->toReadableSize($this->data['User']['quota'])));
?>
</fieldset>
