<h1><?php echo __('Easy set access rights (acl) for your media:')?></h1>

<?php echo $this->Session->flash() ?>

<?php echo $this->Form->create(null, array('action' => "easyacl")); ?>

<fieldset><legend><?php echo __('Select only one tag or group as matching criteria:'); ?></legend>
...
?>
  <legend><?php echo __('Edit access rights (acl) for your current media matching above criteria:'); ?></legend>
<?php
  $aclSelect = array(
