<?php
  ...
  echo "\n";
  echo __("User %s likes to join your group %s.", $user['User']['username'], $group['Group']['name'])."\n";
  echo "\n";
  echo __("To confirm the subscription please visit %s", Router::url("/groups/confirm/{$group['Group']['name']}/{$user['User']['username']}", true))."\n";
  echo "\n";
